...
public class JobSearchAsync extends AsyncTask<String, Void, ArrayList<JobPosition>> {
    private static final String TAG = JobSearchAsync.class.getSimpleName();
    String rawString = "https://jobs.github.com/positions.json?description=";
            ...
            if (resultString != null) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        arrayJobs.add(new JobPosition(title, link));
                    }
    ...
    protected void onPostExecute(ArrayList<JobPosition> jobPositions) {
        ...
        Log.d(TAG, "postExecute: " + jobPositions.size());
